...
df = utils.read_file(full_filename, "zip")
...
column_names = ['askPrice', 'mileage', 'isNew',
                'vf_BasePrice', 'vf_DisplacementCC', 'vf_Doors',
                'vf_EngineHP', 'vf_ModelYear', 'vf_TopSpeedMPH', 'vf_TransmissionStyle']
